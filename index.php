    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                ...
                <form action="handele/handtask.php" method="POST" class="form border p-2 my-5">


                <?php   if(isset($_SESSION['succ'])) :?>

                <?php //foreach($_SESSION['succ'] as $succ): ?>
                ...
                <?php endif; ?>    
                    ...
                    <?php foreach($_SESSION['error'] as $errr): ?>
                ...
                <table class="table table-bordered">
                    ...
                    <?php while($row = mysqli_fetch_assoc($result)):  ?>
                            <tr>
                                ...
                                <td>
                                    <a href="handele/delete-tasks.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> </a>
